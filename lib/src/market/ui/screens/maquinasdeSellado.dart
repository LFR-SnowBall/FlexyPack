...
class MaquinasparaSelladoScreen extends StatefulWidget{
  @override
  State<StatefulWidget> createState() => _MaquinasparaSelladoScreenState();
...
class _MaquinasparaSelladoScreenState extends State<MaquinasparaSelladoScreen>{
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<Cart>(builder: (context, cart,child){
      ...
      appBar: AppBar(
        ...
        title: Text('Maquinas para Sellado'),
        centerTitle: true,
      ),
      body: GridView.builder(
        itemCount: ListProducts().MaquinasparaSellado.length,
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: _ListWidgetsShop.imageHeader(
                        image: imagesRoutes().imageMaquinaParaSellado+ListProducts().MaquinasparaSellado[index]['Image'].toString(),
                        infoaction:(){
                          _ListWidgetsShop.dialogInfoadd(
                            context: context,
                            image:imagesRoutes().imageMaquinaParaSellado+ListProducts().MaquinasparaSellado[index]['Image'].toString(),
                            title: ListProducts().MaquinasparaSellado[index]['Title'].toString(),
                            description2: ListProducts().MaquinasparaSellado[index]['Description2'].toString(),
                            button: _ListWidgetsShop.addCart(action: (){
                              cart.add(image: 'maquinasparasellado/'+ListProducts().MaquinasparaSellado[index]['Image'].toString(), 
                              title: ListProducts().MaquinasparaSellado[index]['Title'].toString(), 
                              description: ListProducts().MaquinasparaSellado[index]['Description1'].toString(),
                              description2: ListProducts().MaquinasparaSellado[index]['Description2'].toString()
                              );
                              }),
                            );
