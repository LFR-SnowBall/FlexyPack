...
class OzonosScreen extends StatefulWidget{
  @override
  State<StatefulWidget> createState() => _OzonosScreenState();
    // TODO: implement createState
}


class _OzonosScreenState extends State<OzonosScreen>{
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<Cart>(builder: (context, cart,child){
      ...
      body: GridView.builder(
        itemCount: ListProducts().Ozonos.length,
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: _ListWidgetsShop.imageHeader(
                        image: imagesRoutes().imageOzonos+ListProducts().Ozonos[index]['Image'].toString(),
                        infoaction:(){
